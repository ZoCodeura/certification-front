          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl">
            ...
            <form onSubmit={handleSubmit} className="p-8 bg-gray-50 rounded-b-2xl">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-700">Diplôme</label>
                  <select
                    name="diplome"
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-700">Mention</label>
                  <select
                    name="mention"
                  ...
                  >
                    ...
                    <option value="Asse-bien">Asse-bien</option>
          ...
          <table className="w-full">
            <thead className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
              <tr>
                ...
                <th className="px-6 py-4 text-left">Diplôme</th>
                <th className="px-6 py-4 text-left">Mention</th>
                <th className="px-6 py-4 text-left">Établissement</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {etudiants.map((et) => (
                <tr key={et.id} className="hover:bg-blue-50 transition-colors">
                  ...
                  <td className="px-6 py-4">{et.diplome}</td>
                  <td className="px-6 py-4">{et.mention}</td>
                  <td className="px-6 py-4">{et.etablissement}</td>
